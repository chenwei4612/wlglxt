...
<div class="pageContainer">
     ...
     <div class="pageSidebar">
         ...
         <li role="presentation">
                 <a href="${APP_PATH}/WEB-INF/users/page/employee2.jsp" target="mainFrame" >员工信息查看</a>
             </li>
             <li role="presentation">
                 <a href="${APP_PATH}/WEB-INF/users/page/car.jsp" target="mainFrame">车辆管理</a>
             </li>
             <li role="presentation">
                 <a href="${APP_PATH}/WEB-INF/users/page/route.jsp" target="mainFrame">线路管理</a>
             </li>
             <li class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                     <li>
                         <a href="${APP_PATH}/WEB-INF/users/page/orst.jsp" target="mainFrame">订单情况</a>
                     </li>
                     <li>
                         <a href="${APP_PATH}/WEB-INF/users/page/orderG.jsp" target="mainFrame">订单详细</a>
                     </li>
                 </ul>
             </li>
             <li role="presentation">
                 <a href="${APP_PATH}/WEB-INF/users/page/storehouse.jsp" target="mainFrame">仓库管理</a>
             </li>
             <!-- 开始 -->
             <li class="dropdown">
                 <a class="dropdown-toggle" data-toggle="dropdown" href="nav4.html" target="mainFrame">
                 ...
                 <ul class="dropdown-menu">
                     <li>
                         <a href="#" id="password_update">修改个人信息</a>
                     </li>
                     <li>
     ...
     <div class="pageContent">
       <iframe src="${APP_PATH}/WEB-INF/users/page/home.jsp" id="mainFrame" name="mainFrame" 
