...
<body>
	...
	<div class="pageContainer">
		...
		<div class="pageSidebar">
			<ul class="nav nav-stacked nav-pills">
				<li role="presentation"><a
					href="${APP_PATH}/WEB-INF/users/page/employee.jsp" target="mainFrame">员工管理</a>
				</li>
				<li role="presentation"><a
					href="${APP_PATH}/WEB-INF/users/page/car.jsp" target="mainFrame">车辆管理</a></li>
				<li role="presentation"><a
					href="${APP_PATH}/WEB-INF/users/page/route.jsp" target="mainFrame">线路管理</a>
				</li>
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="${APP_PATH}/WEB-INF/users/page/orst.jsp"
							target="mainFrame">订单情况</a></li>
						<li><a href="${APP_PATH}/WEB-INF/users/page/orderG.jsp"
							target="mainFrame">订单详细</a></li>
					</ul></li>
				<li role="presentation"><a
					href="${APP_PATH}/WEB-INF/users/page/storehouse.jsp" target="mainFrame">仓库管理</a>
				</li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="nav4.html" target="mainFrame">
					...
					<ul class="dropdown-menu">
						<li><a href="${APP_PATH}/WEB-INF/users/page/DeptCount.jsp"
							target="mainFrame">部门人数统计</a></li>
						<li><a href="${APP_PATH}/WEB-INF/users/page/St_type_count.jsp"
							target="mainFrame">仓库统计</a></li>
						<li><a href="${APP_PATH}/WEB-INF/users/page/OrderGCount.jsp"
							target="mainFrame">订单统计</a></li>
						<li><a href="${APP_PATH}/WEB-INF/users/page/CarCount.jsp"
		...
		<div class="pageContent">
			<iframe src="${APP_PATH}/WEB-INF/users/page/home.jsp" id="mainFrame"
