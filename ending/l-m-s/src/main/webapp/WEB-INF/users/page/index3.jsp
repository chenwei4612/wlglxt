	...
	<div class="pageContainer">
		...
		<div class="pageSidebar">
			<ul class="nav nav-stacked nav-pills">
				<li role="presentation"><a href="car2" target="mainFrame">车辆信息查看</a>
				</li>
				<li role="presentation"><a href="Route2" target="mainFrame">线路信息查看</a>
				</li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="nav4.html" target="mainFrame">
						订单信息查看<span class="caret"></span>
				</a>
					<ul class="dropdown-menu">
						<li><a href="Orst2" target="mainFrame">订单情况信息查看</a></li>
						<li><a href="OrderG2" target="mainFrame">订单详细信息查看</a></li>
					</ul></li>
				<li role="presentation"><a href="Storehouse2"
					target="mainFrame">仓库管理</a></li>
				<!-- 开始 -->
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="nav4.html" target="mainFrame">
