...
%>
<link rel="icon" href="${APP_PATH}/static/img/favicon.ico" mce_href="${APP_PATH}/static/img/favicon.ico"  type="image/x-icon" />
	...
	<div class="pageContainer">
		...
		<div class="pageSidebar">
			<ul class="nav nav-stacked nav-pills">
				<li role="presentation"><a href="Employee" target="mainFrame">员工管理</a>
				</li>
				<li role="presentation"><a href="Car" target="mainFrame">车辆管理</a></li>
				<li role="presentation"><a href="Route" target="mainFrame">线路管理</a>
				</li>
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="Orst" target="mainFrame">订单情况</a></li>
						<li><a href="OrderG" target="mainFrame">订单详细</a></li>
					</ul></li>
				<li role="presentation"><a href="Storehouse" target="mainFrame">仓库管理</a>
				</li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="nav4.html" target="mainFrame">
					...
					<ul class="dropdown-menu">
						<li><a href="DeptCount" target="mainFrame">部门人数统计</a></li>
						<li><a href="St_type_count" target="mainFrame">仓库统计</a></li>
						<li><a href="OrderGCount" target="mainFrame">订单统计</a></li>
						<li><a href="CARCount" target="mainFrame">车辆统计</a></li>
					</ul></li>
				<!-- 开始 -->
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="nav4.html" target="mainFrame">
		...
		<div class="pageContent">
			<iframe src="home" id="mainFrame" name="mainFrame" frameborder="0"
	...
	<div class="modal fade" id="empUpdateModal" tabindex="-1" role="dialog"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="radio-inline"> <input type="radio"
									name="sex" id="gender1_update_input" value="1"
									checked="checked"> 男
		...
		<script type="text/javascript">
			...
			$("#password_update").click(function() {
		    	getEmp("${APP_PHONE}");
				//4、把员工的id传递给模态框的更新按钮
				$("#emp_update_btn").attr("edit-phone","${APP_PHONE}");
		...
		function getEmp(phone) {
			...
			$.ajax({
				...
				success : function(result) {
					...
					$("#role_static").text(empData.role == 1 ? "非正式员工"
							: ((empData.role == 2) ? "正式员工": ((empData.role == 3) ? "司机": ((empData.role == 4) ? "派送员"
										: ((empData.role == 5) ? "管理员": "经理")))));
				}
			});
		}
		//点击更新，更新员工信息
