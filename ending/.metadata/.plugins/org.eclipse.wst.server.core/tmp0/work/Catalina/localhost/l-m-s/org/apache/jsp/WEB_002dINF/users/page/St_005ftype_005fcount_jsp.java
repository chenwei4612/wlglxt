 ...
 * Generated at: 2020-04-01 08:18:37 UTC
...
public final class St_005ftype_005fcount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>仓库统计 柱形图</title>\r\n");
	...
	pageContext.setAttribute("APP_PATH", request.getContextPath());
      ...
      out.write("    \t\tvar emps = result.extend.sths;\r\n");
      out.write("    \t\tconsole.log(emps);\r\n");
      out.write("    \t\tconsole.log(emps.length);\r\n");
      out.write("\t    \t/*  $.each(emps,function(index, item) {\r\n");
      out.write("\t    \t\t tt1[item]=item.deName;\r\n");
      out.write("\t    \t\t tt2[item]=item.num;\r\n");
      out.write("\t    \t\tvar deName = $(tt1).append(item.deName);\r\n");
      out.write("\t\t\t\tvar num = $(tt2).append(item.num);\r\n");
      out.write("\t    \t});  */\r\n");
      out.write("\t    \t if(emps.length>0){\r\n");
      out.write("\t\t\t\t\tfor (var i = 0; i < emps.length; i++) {\r\n");
      out.write("\t\t\t\t\t\ttt1[i]=emps[i].type;\r\n");
      out.write("\t\t\t\t\t\ttt2[i]=emps[i].num;\r\n");
      out.write("\t\t\t\t\t\tvar obj = new Object();\r\n");
      out.write("\t\t\t\t\t\tobj.name = emps[i].type;\r\n");
      out.write("\t\t\t\t\t\tobj.value = emps[i].num;\r\n");
      out.write("\t\t\t\t\t\ttt3[i] = obj;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t    \t }\r\n");
      out.write("\t    \t//console.log(tt1);\r\n");
      out.write("\t    \t//console.log(tt2);\r\n");
      ...
      out.write("\t    \tif(emps.length>0){\r\n");
      out.write("\t\t\t\t\tfor (var i = 0; i < emps.length; i++) {\r\n");
      out.write("\t\t\t\t\t\ttt4[i]=emps[i].stId;\r\n");
      out.write("\t\t\t\t\t\ttt5[i]=emps[i].num;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t    \t } \r\n");
      out.write("\t    \t// 使用刚指定的配置项和数据显示图表。\r\n");
      out.write("\t    \t\tMChart3();\r\n");
